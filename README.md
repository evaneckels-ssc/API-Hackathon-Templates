...
### Code Examples
- Generate Summary Reports for Full Portfolio (see full guide on [SecurityScorecard Documentation Page](https://securityscorecard.readme.io/docs/ssc-api-guide-automatically-generate-and-download-all-reports-for-a-portfolio))
    - [Script with Terminal Interface](https://github.com/evaneckels-ssc/API-Hackathon-Templates/blob/main/Code%20Examples/Summary-Report-From-Portfolio/generate_ssc_reports.py) (Python)
    - [Script with GUI Interface](https://github.com/evaneckels-ssc/API-Hackathon-Templates/blob/main/Code%20Examples/Summary-Report-From-Portfolio/generate_ssc_reports_gui.py) (Python)
